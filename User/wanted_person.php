...
<section class="contact py-5" id="contact">
	<div class="container py-3 py-md-3">
		...
		<div class="contact-grids row contact-form">
			...
			<h4 class="heading"><font color="blue" size="6" face="times new roman"><u>Wanted Persons</a></font></h4>
       	...
       	<tr class="<?php echo $cls ?>">
       		...
       		<td>
       			...
       			<div style="width:75%; float: right">
       				<a class="btn btn-danger" href="add_alert_info.php?wanted_id=<?php echo $row['wanted_id']; ?>">Add Information</a>
