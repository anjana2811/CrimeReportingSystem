...
<section class="contact py-5" id="contact">
	<div class="container py-3 py-md-3">
		...
		<div class="contact-grids row">
			...
			<h4 class="heading"><a class="navbar-brand" href="index.php"><font color="blue" size="6" face="times new roman"><u>Feedback</u></a></font></h4>
				<form method="post" action="feedback_action.php" name="f1">
								<table width="100%" cellspacing="8"><tr><td>Feedback</td>
									<td><textarea name="feedback" type="text" id="feedback" rows=8"></textarea></td></tr>
								
								
	<tr><td colspan="2"><input type="submit" onclick="return validate_feedback()" value="Submit"></td></tr>
							</table>
							</form>
			</div>
			<div class=" col-lg-7 ">
...
$count=1;
  $cls="odd";
 $sql="select * from tbl_feedback where tbl_feedback.login_id=$logid";
