...
<section class="contact py-5" id="contact">
	<div class="container py-3 py-md-3" style="min-height: 320px">
			<div class="w3-head-all text-center mb-3">
			<h3></h3>
		   </div>
		<div class="contact-grids row">
			<div class=" col-lg-9 contact-form">
			<h4 class="heading"><a class="navbar-brand" href="index.php"><font color="red" size="6" face="Algerian">Welcome to Crime Reporting System</font></a></h4>
