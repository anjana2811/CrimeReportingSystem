...
{ 
  ...
  <!--Header-->
   ...
   <a class="navbar-brand" href="index.php"><a class="navbar-brand" href="index.php"><font color="black" size="6" face="times new roman">Crime Reporting System</a></font></h4>
...
<section class="contact py-5" id="contact">
	<div class="container py-3 py-md-3">
		...
		<div class="contact-grids row">
				...
				<h4 style="width: 40%; margin: auto; padding:20px 0" align="center"><u><font color="blue">Details of your Complaint</u></font></h4>
			<?php
...
$res22=$db->query_execute($qry1);
  $count=1;
           ...
           {
           ?>
        <tr class="thead-light"><th style="color:#fff; font-size: 20px; text-align: center" colspan="2" ><h4 ><font color="blue" size="4">Complaint Details</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 14px;">Complaint Registered date&nbsp; &nbsp;<?php echo $row["entry_date"]?></span></th></tr>
                        ...
                        <tr><th>Gender </th><td><?php echo $row["gender"]?></td></tr>
                         ...
                         <tr><th>Phone Number </th><td><?php echo $row["phone_number"]?></td></tr>
                          ...
                          <tr  class="thead-light"><th style="color:#fff; font-size: 20px; text-align: center" colspan="2" ><h4><font color="blue">Crime Details</font></th></tr>
...
<?php echo $row["state_name"]?>
                          ...
                          <tr><th>Status </th><td>
                           ...
                           <tr class="tblhead"><th style="color:#fff; font-size: 20px; text-align: center" colspan="2" ><h4><font color="blue">Victim Details</font></th></tr>
                                  <?php
