...
<section class="contact py-5" id="contact">
	<div class="container py-3 py-md-3">
		...
		<div class="contact-grids row">
			...
			<h4 class="heading"><font color="blue" size="6" face="times new roman"><u>Wanted Information</u></a></font></h4>
<form method="post" action="wanted_info_action.php" name="f1" enctype="multipart/form-data">
								<table width="100%" cellspacing="8"><tr><td>Description</td>
									<td><textarea name="description" type="text" id="description" rows="8" required=""></textarea></td></tr>
	<tr><td>File</td>
<td><input type="file" name="file" id="file" required></td></tr>							
								
	<tr><td colspan="2"><input type="hidden" name="wanted_id" value="<?php echo $_GET['wanted_id']; ?>"><input type="submit" onclick="return validate_alert_info()" value="Submit"></td></tr>
							</table>
							</form>
			</div>
			<div class=" col-lg-7 ">
...
$count=1;
  $cls="odd";
  $sql="select * from tbl_wanted_info inner join  tbl_wanted on tbl_wanted_info.wanted_id=tbl_wanted.wanted_id where tbl_wanted_info.user_login_id=$logid and tbl_wanted_info.wanted_id='$wanted_id'";
...
if($n>0)
{
	...
	<thead>
							<tr><th>SL No</th>
								<th>Name</th>
								<th>Case Details</th>
			<th>Wanted Info Description</th>		<th>Entry Date</th>				
...
<td><?php echo $row["case_details"];?></td>      	<td><?php echo $row["description"];?></td>  	<td><?php echo $row["entry_date"];?></td> 	
