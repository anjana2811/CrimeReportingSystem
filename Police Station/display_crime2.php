...
if($n>0)
{
  ...
  <thead class="thead-light">
             <tr><th>SL NO</th><th>Crime ID</th><th>Crime Subject</th><th>Crime Date & Time</th><th>Crime Place</th><th>Complaint Registered Date</th>
            <th>Add Culprit</th>
<th>Add Details</th>
<th>Close</th>            
<th>More Details</th> 
...
<div><?php echo $row["state_name"] ?></div>
  ...
  <td><a class="button" href="add_culprit.php?crime_id=<?php echo $row["crime_id"] ?>">Add Culprit</a></td>
  <td><a class="button" href="add_investigation_details.php?crime_id=<?php echo $row["crime_id"] ?>">Add Investigation Details</a></td>       
<td><a class="button" href="close_complaint.php?crime_id=<?php echo $row["crime_id"] ?>">Close</a></td>
