...
move_uploaded_file($_FILES["photo"]["tmp_name"], "culprit_photo/".$filename);
}      
  $culprit_id=$_POST["culprit_id"];
    //Include dboperation class file 
 include_once("../dbconnection.php");
 // code to create object of class dboperations
       $db=new dbconnection();
 $sql2="update tbl_culprit set photo='$filename' where culprit_id=$culprit_id";
        $res1=$db->query_execute($sql2);
            ...
            if($res1)
            {
              ?>
              <script type="">
                alert("Photo is added Successfully");
