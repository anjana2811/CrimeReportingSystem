...
<section class="contact py-5" id="contact">
	<div class="container py-3 py-md-3">
		...
		<div class="contact-grids row">
			...
			<h4 class="heading">  <font color="blue" size="6" face="times new roman"><u>Evidence Details</a></u></font></h4>
<form method="post" action="evidence_action.php" name="f1" enctype="multipart/form-data" required>
<table width="100%" cellspacing="8"><tr><td>Evidence Description</td>

<td><textarea name="evidence_desc" type="text" id="evidence_desc" rows="8"></textarea></td></tr>
	<tr><td>File</td>
...
$count=1;
  $cls="odd";
  $sql="select * from tbl_evidence inner join  tbl_crime on tbl_evidence.crime_id=tbl_crime.crime_id where  tbl_crime.crime_place=(select place_id from tbl_police_station where login_id='$login_id') and tbl_crime.crime_id='$crime_id'";
...
<td><?php echo $row["evidence_description"];?></td>  	
<td><?php echo $row["evidence_entry_date"];?></td> 	
<td><a class="btn btn-success" href="decrypt_evidence.php?file=<?php echo $row["file_name"] ?>">Decrypt Evidence </a></td>
