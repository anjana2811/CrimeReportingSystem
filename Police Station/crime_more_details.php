...
<section class="contact py-5" id="contact">
	<div class="container py-3 py-md-3" style="min-height: 350px;">
			...
			<h2><font color="blue"><u>Crime Details </u></font></h2>
		   </div>
...
$res22=$db->query_execute($qry1);
  $count=1;
           ...
           {
           ?>
        <tr class="thead-light"><th style="color:#fff; font-size: 20px; text-align: center" colspan="2" ><h4><font color="blue">Complaint Details</font></h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 14px;">Complaint Registered date:&nbsp; &nbsp;<?php echo $row["entry_date"]?></span></th></tr>
                        ...
                        <tr><th>Gender </th><td><?php echo $row["gender"]?></td></tr>
                         ...
                         <tr><th>Phone Number </th><td><?php echo $row["phone_number"]?></td></tr>
                          ...
                          <tr  class="thead-light"><th style="color:#fff; font-size: 20px; text-align: center" colspan="2" ><h4><font color="blue">Crime Details</font></h4></th></tr>
...
<?php echo $row["state_name"]?>
                          ...
                          <tr><th>Status </th><td>
                           ...
                           <tr class="thead-light"><th style="color:#fff; font-size: 20px; text-align: center" colspan="2" ><h4><font color="blue">Victims Details</font></h4></th></tr>
                                  <?php
               ...
               <th>Gender</th> <td>
               	<?php echo $row["victim_gender"];?></td></tr>
                                 ...
                                 <?php
                                          ...
                                          ?>
<tr  class="thead-light"><th style="color:#fff; font-size: 20px; text-align: center" colspan="2" ><h4><font color="blue">Investigation Report</font></h4></th></tr>
                                  <?php
