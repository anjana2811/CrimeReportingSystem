...
<section class="contact py-5" id="contact">
	<div class="container py-3 py-md-3">
		...
		<div class="contact-grids row">
			...
			<h4 class="heading"><font color="blue" size="6" face="times new roman"><u>Wanted Information</font></u></h4>
...
$count=1;
  $cls="odd";
  $sql="select * from tbl_wanted_info inner join  tbl_wanted on tbl_wanted_info.wanted_id=tbl_wanted.wanted_id inner join tbl_user_registration on tbl_wanted_info.user_login_id=tbl_user_registration.login_id where tbl_wanted_info.wanted_id='$wanted_id'";
...
if($count%2==0)
{
	$cls="even";
     ...
     <td>Name: <?php echo $row["firstname"]." ".$row["lastname"] ?><br>
     	...
     	Phone No: <?php echo $row["phone_number"];?><br></td>
