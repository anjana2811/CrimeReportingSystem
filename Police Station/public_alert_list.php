...
<section class="contact py-5" id="contact">
	<div class="container py-3 py-md-3">
		...
		<div class="contact-grids row contact-form">
			...
			<h4 class="heading"><font size="6" color="blue" face="times new roman"><u>Wanted Persons</u></font></h4>
...
?>
       				<a class="btn btn-danger" href="alert_info.php?wanted_id=<?php echo $row['wanted_id']; ?>">Information</a>
