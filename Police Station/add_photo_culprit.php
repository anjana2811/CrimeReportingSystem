...
<section class="contact py-5" id="contact">
	<div class="container py-3 py-md-3">
		...
		<div class="contact-grids row">
		  ...
		  <h4 class="heading"><font color="blue" size="5" face="times new roman"><u>Change Photo</a></u></font></h4>		
	<form action="add_culprit_photo_action.php" name="f1" method="post" enctype="multipart/form-data"><table>
                                            
      <tr><td>Photo</td><td><input type="file" name="photo" id="photo" placeholder="photo"  ></td></tr>     
      <tr><td><input type="hidden" name="culprit_id" value="<?php echo $_GET["culprit_id"]; ?>"><input type="submit" onclick="return validate_file()" value="Submit">  </td></tr>                     
