...
$crime_id=$_GET["crime_id"];
				?>
			<h4 class="heading"><font color="blue size="6" face="times new roman"><u>Investigation</h4></u></font>
				<form action="add_investigation_action.php" method="post" name="f1" >
						<table style="width: 100%; margin: auto">

		<tr><td>Investigation </td><td><textarea name="investigation" id="investigation"></textarea></td></tr>
				
		<tr><td colspan="2" style="text-align: center;">
			<input type="hidden" name="crime_id" value="<?php echo $crime_id ?>">
			<input style="margin-top:5px" type="submit" value="Submit" onclick="return validate_investigation()" /></td></tr>
							</table>
						</form>
			</div>
			<div class=" map">
