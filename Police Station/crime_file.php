...
<section class="contact py-5" id="contact">
	<div class="container py-3 py-md-3" style="min-height: 350px;">
			...
			<h2 align="center"><font color="blue" face="times new roman" size="6"><u>Crime File</u></font></h2>
		   </div>
...
<td>
	...
	{
?>
<img width="200" cols="150" src="../User/Crime_file/<?php echo $row['file_name']?>">
<?php
	}
	else
	{
?>
<a class="btn btn-info" href="view_crime_file.php?crime_file_id=<?php echo $row["crime_file_id"];?>">Click Here to Play Video</a>
<?php
	}
	?>
</td> 	
