...
{ 
  ...
  <!--Header-->
   ...
   <a class="navbar-brand" href="index.php"><font color="black" size="6" face="times new roman">Crime Reporting System</font>
...
<section class="contact py-5" id="contact">
	<div class="container py-3 py-md-3" style="min-height: 350px;">
			...
			<h2 align="center"><font color="blue" size="6" face="times new roman"><u>Crime List</u></font></h2>
			
		   </div>
		<div class="contact-grids row">
			<table class="table contact-form" >
<tr><td>Search by Date</td><td><div> <input type="text" name="date" id="date" onchange="display_crime()"></div></td></tr>
				<tr><td>Category</td> <td>
<select name="category" id="category" onchange="display_crime_category2()">
...
while($row=mysqli_fetch_array($res))
{
 ...
 <?php
         ...
         ?></select></td><td>Crime ID</td><td><input type="text" name="crime_id" id="crime_id" onkeyup="display_crime_by_crime_id2()"></td></tr>
