...
<section class="contact py-5" id="contact">
	<div class="container py-3 py-md-3">
		...
		<div class="contact-grids row">
			...
			<h4 class="heading">OTP</h4>
				<form action="otp_action.php" method="post" name="f1">
						<div>
								<?php echo $_SESSION["otp"]; ?>
						    	<span><label>OTP</label></span>
						    	<span><input type="text" name="otp" id="otp" value="">
<input type="hidden" name="loginid" value="<?php echo $_GET['logid']; ?>">
						    	</span>
						    </div>
						   
						   
						   <div>
						   		<span><input type="submit" value="Submit" onclick="return validate_otp()"></span>
						  </div>
					    </form>
			</div>
