	...
	<div class="container py-3 py-md-3">
		...
		<div class="contact-grids row">
			...
			<h4 class="heading">Add Category</h4>
				<form action="add_category_action.php" name="f1" method="post"><table>
                                            
      <tr><td>Category</td><td><input type="text" name="category" id="category" placeholder="Category"  ></td></tr>     
      <tr><td><input type="submit" onclick="return validate_category()" value="Submit">  </td></tr>                     
...
<td><a class="button" href="delete_crime_category.php?category_id=<?php echo $row["category_id"] ?>">Delete</a></td>
