...
<section class="contact py-5" id="contact">
 <div class="container py-3 py-md-3">
  ...
  <div class="contact-grids row">
   <h4 class="heading"  style="margin-bottom: 10px"><font color="red" face="times new roman" size="5">Approved Police Station List</font></h4>
   <a style="margin:0 0  10px 20px;" href="police_station_list.php" class="btn btn-success">Click Here to view Approved Police Station</a>
 </div>
     <h4 class="heading"  style="margin-bottom: 10px" align="center"><u><b><font color="blue" face="times new roman" size="6"><br>Approve or Reject Police Station</font></b></u></font></h4>
   <?php 
...
<td><a class="btn btn-info" href="approve_police_station.php?login_id=<?php echo $row["login_id"] ?>">Approve</a></td>
<td><a class="btn btn-danger" href="reject_police_station.php?login_id=<?php echo $row["login_id"] ?>">Reject</a></td>
