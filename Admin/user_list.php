...
{ 
  ...
  <!--Header-->
   ...
   <a class="navbar-brand" href="index.php">Crime Reporting System<font color="black" size="6" face="times new roman"></font></a>
  ...
  <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
     ...
     <li class="nav-item ">
      ...
      <!--//banner -->
      <!-- contact -->
<section class="contact py-5" id="contact" style="min-height: 400px">
	<div class="container py-3 py-md-3">
			<div class="w3-head-all text-center mb-3">
			<h4 align="text-center"><font color="dark pink" face="times new roman" size="6"><u><b>Complained Person List</b></u></font></h4>
		   </div>
...
$count=1;
  ...
  $qry1="select * from tbl_user_registration  where login_id in (select login_id from tbl_crime)";
  $res2=$db->query_execute($qry1);
...
if($n>0)
{
	...
	<thead>
						 <tr><th>SL NO</th><th>Name</th><th>Address</th><th>Phone Number</th><th>Pincode</th>
