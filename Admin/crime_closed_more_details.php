...
$res22=$db->query_execute($qry1);
  $count=1;
           ...
           {
           ?>
        <tr class="thead-light"><th style="color:#fff; font-size: 20px; text-align: center" colspan="2" ><h4><font color="blue"><u>Complaint Details </u></font></h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 14px;">Complaint Registered date:&nbsp; &nbsp;<?php echo $row["entry_date"]?></span></th></tr>
                        ...
                        <tr><th>Gender </th><td><?php echo $row["gender"]?></td></tr>
                         ...
                         <tr><th>Phone Number </th><td><?php echo $row["phone_number"]?></td></tr>
                          ...
                          <tr  class="thead-light"><th style="color:#fff; font-size: 20px; text-align: center" colspan="2" ><h4><font color="blue"><u>Crime Details</u></font></h4> </th></tr>
...
<?php echo $row["state_name"]?>
                          ...
                          <tr><th>Status </th><td>
                           ...
                           <tr class="thead-light"><th style="color:#fff; font-size: 20px; text-align: center" colspan="2" ><h4><font color="blue"><u>Victims Details</u></font></h4> </th></tr>
                                  <?php
               ...
               <th>Gender</th> <td>
               	<?php echo $row["victim_gender"];?></td></tr>
                                 ...
                                 <?php
                                          ...
                                          ?>
<tr  class="thead-light"><th style="color:#fff; font-size: 20px; text-align: center" colspan="2" ><h4><font color="blue"><u>Investigation Report</u></font></h4> </th></tr>
                                  <?php
        ...
        <th>Report on <?php echo $row["entry_date"];?></th> <td><?php echo $row["investigation_report"];?></td></tr> <tr>
                                 ...
                                 <?php
                                          $c++;
                                            ...
                                            <tr class="thead-light"><th style="color:#fff; font-size: 20px; text-align: center" colspan="2" ><h4><font color="blue"><u>Culprit Details</u></font></h4> </th></tr>
                                  <?php
