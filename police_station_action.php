...
//Include dboperation class file 
 ...
 $sql="insert into tbl_login(user_name,password,user_type,status) values('$username','$password','Police Station','Submitted')";
       ...
       $sql2="insert into tbl_police_station(address, zipcode, email, phone_number, place_id, login_id) values('$address','$zipcode','$email','$phno','$place','$login_id')";
        $res1=$db->query_execute($sql2);
            ...
            if($res1)
            {
             ...
             window.location="police_station_registration.php";
